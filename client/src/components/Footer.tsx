      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h3 className="font-display text-xl font-medium mb-2">Wedding Song Planner</h3>
            <p className="text-neutral-300 text-sm">Making your ceremony music selection simple and beautiful.</p>
          </div>
          <div className="flex flex-col md:flex-row gap-6">
            <div>
              <h4 className="text-lg font-medium mb-2">Contact</h4>
              <p className="text-neutral-300 text-sm">choir@weddingsongs.example.com</p>
              <p className="text-neutral-300 text-sm">+1 (123) 456-7890</p>
            </div>
            <div>
        ...
        <div className="mt-8 pt-4 border-t border-neutral-700 text-center">
          <p className="text-neutral-400 text-sm">© {new Date().getFullYear()} Wedding Song Planner. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
